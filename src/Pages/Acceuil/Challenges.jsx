...
import Footer2 from './Footer2'
    ...
    const handleNav = ({ books }) => {
    setNav(!nav);
    };

   
    const challenges = [
      { name: "Daily reading", streak: 5, longestStreak: 10 },
      { name: "First book of the month", streak: 2, longestStreak: 4 },
      { name: "Read your first book", streak: 3, longestStreak: 7 }
    ];
    ...
    <div>
        ...
        <div className="bg-[#000300] mt-6 mx-4 md:mx-20 lg:mx-40">
          <div className="flex flex-col items-start justify-between mb-4 ">
            <span class="text-sm font-normal ml-4 md:ml-10 mt-3">
              <span class="text-gray-400">Level:</span>
              <span class="text-green-400 ml-2">Intermidiare</span>
            </span>
          </div>
          {challenges.map((challenge, index) => (
            <div className="bg-gray-700 rounded-lg flex flex-col sm:flex-row items-center justify-between w-full h-auto sm:h-16 mb-4 text-white" key={index}>
